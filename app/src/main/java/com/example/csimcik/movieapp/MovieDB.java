...
import static com.example.csimcik.movieapp.ImageAdapter.*;

/**
 * Created by csimcik on 4/17/2016.
 */
public class MovieDB extends AsyncTask<Void,Void,String> {
    String poster;
    String synopsis;
    String title;
    String release;
                ...
                try {
                    ...
                    for(int i=0; i < lengthJsonArr; i++)
                    {
                        ...
                        if( idList.size() < jsonMainNode.length()) {
                            ImageAdapter.idList.add(new FavorItem(movieID,true));
                           //movieDB.insertRecord(new FavorItem(movieID,true));
                        }
